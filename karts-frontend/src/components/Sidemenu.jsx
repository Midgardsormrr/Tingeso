  ...
  const listOptions = () => (
    ...
    >
      <List>
        ...
        <ListItemButton onClick={() => navigate("/clients")}> {/* Nueva opción para Clientes */}
          <ListItemIcon>
            <PersonIcon /> {/* Icono para Clientes */}
          </ListItemIcon>
        ...
        <ListItemButton onClick={() => navigate("/paycheck/list")}>
          ...
          <ListItemText primary="Planillas Sueldos" />
        </ListItemButton>
        ...
        <ListItemButton onClick={() => navigate("/reports/AnualReport")}>
          ...
          <ListItemText primary="Gráficos de Planillas" />
        </ListItemButton>
      </List>
      ...
      <List>
        ...
        <ListItemButton onClick={() => navigate("/paycheck/medicalleave")}>
          ...
          <ListItemText primary="Licencias Médicas" />
        </ListItemButton>
      </List>
    </Box>
  );
